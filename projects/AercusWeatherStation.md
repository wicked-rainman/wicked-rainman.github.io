...
The code to do this (written for a Raspberry pi) is held in file [UdpBroadcaster.c](https://github.com/wicked-rainman/M5Stack-Fire "Re-broadcasting TCP client data as UDP packets") I run it as a demon service using systemctl.
